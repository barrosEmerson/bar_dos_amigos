package br.com.barrostech.bar.service;
...
public class RelatorioService {
	...
	public byte[] gerarRelatorioValidade(PeriodoRelatorio periodoRelatorio) throws Exception {
		...
		InputStream inputStream = this.getClass()
				.getResourceAsStream("/relatorios/relatorio_produtos_cadastrados.jasper");
